...
local:
	...
	$(CC) -c -g -D__XMLSEC_FUNCTION__=__func__ -DXMLSEC_NO_SIZE_T -DXMLSEC_NO_GOST=1 -DXMLSEC_NO_GOST2012=1 -DXMLSEC_DL_LIBLTDL=1 -I/home/jord7580/dev/xmlsec1-1.2.28/include -I/usr/include/libxml2 -DXMLSEC_CRYPTO_OPENSSL=1 -DUNIX_SOCKETS -Wall -fPIC -o lua_saml.o lua_saml.c
	$(CC) -g -L/home/jord7580/dev/xmlsec1-1.2.28 -L/usr/lib -lltdl -lxmlsec1-openssl -lxmlsec1 -lz -llzma -licui18n -licuuc -licudata -ldl -lxslt -lxml2 -lm -lssl -lcrypto -lluajit-5.1 -shared -o saml.so -Wl,-rpath=/home/jord7580/dev/xmlsec1-1.2.28 lua_saml.o saml.o
